...
/**
 * Class SwitchBar: a subclass of the Bar class that gives the bar user click functionality of a two-way switch.
 * It can display alternating text as switch is toggled.
 */
