...
public class Button extends AdvancedActor {
    ...
    public void updateTouchState(){
        try{
            ...
            touched = ActorVisitor.containsPoint(this, mouse.getX(), mouse.getY());
            //touched = ActorVisitor.containsPoint(this, MouseInfoVisitor.getPx(mouse), MouseInfoVisitor.getPy(mouse));
        }catch(Exception e){
            touched = false;
        }
    }
