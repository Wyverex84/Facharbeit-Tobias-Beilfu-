...
public final class Physics {
     ...
     * @see #G_EARTH
     */
    public static final Vector G_EARTH_VEC = new Vector(0, 0, -G_EARTH);
    ...
    public static final class Mechanics {
         ...
         * @return The distance traveled
         */
        public static final Vector distTraveled(Vector velocity, double time) {
         ...
         * @return The average velocity
         */
        public static final Vector velocity(Vector distance, double time) {
         ...
         * @return The distance traveled
         */
        public static final Vector distTraveled(Vector acceleration, double time, Vector velocity0) {
         ...
         * @return The final velocity
         */
        public static final Vector velocity(Vector acceleration, double time, Vector velocity0) {
         ...
         * @return The final velocity
         */
        public static final Vector fallVel(double time, Vector velocity0) {
         ...
         * @return The final velocity
         */
        public static final Vector fallDist(double time, Vector velocity0) {
         ...
         * @return The time the objects rises
         */
        public static final Vector riseTime(Vector velocity0) {
         ...
         * @return The time the object rises
         */
        public static final Vector riseTime(Vector decceleration, Vector velocity0) {
            return new Vector(velocity0.x / decceleration.x, velocity0.y / decceleration.y, velocity0.z / decceleration.z);
        }
         ...
         * @return The rise height
         */
        public static final Vector riseHeight(Vector velocity0) {
         ...
         * @return The rise height
         */
        public static final Vector riseHeight(Vector decceleration, Vector velocity0) {
            return new Vector(
         ...
         * @return The final velocity
         */
        public static final Vector throwVel(double time, Vector velocity0) {
         ...
         * @return The final velocity
         */
        public static final Vector throwVel(double acceleration, double time, Vector velocity0) {
            return new Vector(velocity0.x, velocity0.y, velocity(acceleration, time, velocity0.z));
        }
         ...
         * @return The location
         */
        public static final Vector throwLoc(double time, Vector velocity0) {
         ...
         * @return The location
         */
        public static final Vector throwLoc(double acceleration, double time, Vector velocity0) {
            return new Vector(distTraveled(velocity0.x, time), distTraveled(velocity0.y, time), distTraveled(acceleration, time, velocity0.z));
        }
         ...
         * @return The force
         */
        public static final Vector force(double mass, Vector acceleration) {
    ...
    public static final class Relativity {
         ...
         * @return The lorenz factor
         */
        public static final double lorenzFactor(Vector velocity) {
         ...
         * @return The time in the second inertial system
         */
        public static final double timeDilated(Vector velocity, double time) {
            return lorenzFactor(velocity) * time;
        }
         ...
         * @return The contracted length
         */
        public static final double lengthContracted(Vector velocity, double length) {
            return length / lorenzFactor(velocity);
        }
         ...
         * @return The mass while moving
         */
        public static final double mass(Vector velocity, double mass) {
            return lorenzFactor(velocity) * mass;
        }
         ...
         * @return The kinetic energie of the mass
         */
        public static final double kineticEnergy(Vector velocity, double mass) {
            return (lorenzFactor(velocity) - 1) * mass * C * C;
        }
