...
public abstract class Collider extends Actor{
     ...
     */
    protected Collider(Actor host, Transform offset, Vector size){
        this.host = host;
        this.offset = offset;
     ...
     */
    public abstract Vector getWorldEdge();
     ...
     */
    public abstract Vector getEdgeTowards(Actor a);
    ...
    public void setLocation(int x, int y){
        Vector angularOffset = Vector.angledVector(
