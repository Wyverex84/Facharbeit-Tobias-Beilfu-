...
import rccookie.greenfoot.game.AdvancedActor;
import rccookie.greenfoot.game.physics.PhysicalActor;
...
import rccookie.greenfoot.game.physics.BoxCollider;
import rccookie.greenfoot.game.physics.Collider;
import rccookie.data.json.JsonField;
import rccookie.data.json.JsonSerializable;
import rccookie.event.Time;
...
public abstract class AdvancedActor extends Actor implements Serializable {
    ...
    protected UIWorld getUIWorld() {
        return getWorldOfType(UIWorld.class);
    }
