...
import com.github.rccookie.greenfoot.ui.Panel;
import com.github.rccookie.greenfoot.ui.UIMap;

public abstract class GameWorld extends UIMap {
     ...
     */
    private class PausePanel extends Panel {
         ...
         */
        private class PauseUIBackground extends Panel {
     ...
     */
    private class Result extends UIMap {
     ...
     */
    private class Highscores extends UIMap {
